...
import com.example.sellerdashboard.R.*
import com.example.sellerdashboard.adapter.CategoryAdapter
import com.example.sellerdashboard.databinding.FragmentCategoryBinding
...
private lateinit var binding : FragmentCategoryBinding
    ...
    override fun onCreateView(
        ...
        dialog.setContentView(layout.progress_layout)
    ...
    private fun storeData(categoryName: String, url: String) {
        ...
        db.collection("categories").add(data)
            .addOnSuccessListener {
                dialog.dismiss()
                binding.imageView.setImageDrawable(resources.getDrawable(R.drawable.image))
